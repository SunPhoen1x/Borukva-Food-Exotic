...
public class Grill extends BlockWithEntity implements FactoryBlock, BlockEntityProvider, InventoryProvider {
    ...
    public static final class Model extends BlockModel{
        public static final ItemStack LIT_FALSE = ItemDisplayElementUtil.getModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/grill"));
        public static final ItemStack LIT_TRUE = ItemDisplayElementUtil.getModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/grill_on"));
