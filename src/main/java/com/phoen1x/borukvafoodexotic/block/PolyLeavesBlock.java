...
public class PolyLeavesBlock extends LeavesBlock implements PolymerTexturedBlock {
    ...
    public PolyLeavesBlock(Settings settings, String modelId) {
        super(settings);
        model = PolymerBlockResourceUtils.requestBlock(BlockModelType.TRANSPARENT_BLOCK, PolymerBlockModel.of(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/"+ modelId)));
        modelWaterlogged = PolymerBlockResourceUtils.requestBlock(BlockModelType.TRANSPARENT_BLOCK_WATERLOGGED, PolymerBlockModel.of(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/"+modelId)));
    }
