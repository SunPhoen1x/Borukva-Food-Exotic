...
public class Rack extends BlockWithEntity implements TransparentTripWire, FactoryBlock, BlockEntityProvider, InventoryProvider {
    public static final BooleanProperty LIT;
    public static final DirectionProperty FACING;
    public static final MapCodec<Rack> CODEC;
    private Model model;

    static {
        FACING = Properties.HORIZONTAL_FACING;
        LIT = Properties.LIT;
        CODEC = createCodec(Rack::new);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (!player.isSneaking() && world.getBlockEntity(pos) instanceof RackBlockEntity entity) {
    ...
    public static final class Model extends BlockModel {
        public static final ItemStack MODEL = BaseItemProvider.requestModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/rack"));
        public ItemDisplayElement[] items = new ItemDisplayElement[9];
        public ItemDisplayElement rack;
        ...
        public void init(BlockState state) {
            this.rack = ItemDisplayElementUtil.createSimple(MODEL);
            this.rack.setTranslation(new Vector3f(0, 0, 0));
            this.rack.setScale(new Vector3f(2f));
            this.rack.setDisplaySize(1f, 1f);
            this.addElement(rack);
        ...
        private void updateStatePos(BlockState state) {
            ...
            this.rack.setYaw(yaw);
            this.rack.setPitch(180f);
