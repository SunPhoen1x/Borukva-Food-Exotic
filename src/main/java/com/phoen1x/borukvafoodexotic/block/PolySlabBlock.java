...
public class PolySlabBlock extends SlabBlock implements FactoryBlock, PolymerTexturedBlock {
    ...
    public PolySlabBlock(Settings settings, String path, BlockState base) {
        ...
        TOP_SLAB_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(MOD_ID, "block/" + path + "_top"));
        BOTTOM_SLAB_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(MOD_ID, "block/" + path));
    }
    @Override
