...
public class OrangeFruitLeaves extends ApricotFruitLeaves {
    public OrangeFruitLeaves(Settings settings) {
        super(settings);
        MODEL_TRUE = ItemDisplayElementUtil.getModel(id("block/orange_fruit_leaves_has_fruit"));
        MODEL_FALSE = ItemDisplayElementUtil.getModel(id("block/orange_fruit_leaves"));    }
