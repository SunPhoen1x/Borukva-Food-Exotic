...
public class StrawberryCrop extends CropBlock implements FactoryBlock, TransparentPlant {
    ...
    public static class Model extends BlockModel {
        ...
        static{
            for (int i = 0; i <= 3; i++){
                MODELS.add(ItemDisplayElementUtil.getModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/strawberry_crop_stage"+i)));
            }
        }
