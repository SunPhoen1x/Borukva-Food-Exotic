...
public class GreenBeanCrop extends TomatoCrop {
    ...
    public static class Model extends TomatoCrop.Model {
        ...
        static {
            for (int i = 0; i <= 5; i++) {
                MODELS.add(ItemDisplayElementUtil.getModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/green_bean_crop_stage" + i)));
            }
        }
