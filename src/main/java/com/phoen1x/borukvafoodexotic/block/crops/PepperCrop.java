...
public class PepperCrop extends CropBlock implements FactoryBlock, TransparentPlant {
    public static final int MAX_AGE = 7;
    public static final IntProperty AGE = Properties.AGE_7;
    public PepperCrop(Settings settings) {
        super(settings);
    }
    ...
    public static class Model extends BlockModel {
        ...
        static{
            for (int i = 0; i <= 5; i++){
                MODELS.add(ItemDisplayElementUtil.getModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/pepper_crop_stage"+i)));
            }
        }
