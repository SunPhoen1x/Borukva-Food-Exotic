...
public class ModConfiguredFeatures {
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?,?>> context) {
        ...
        register(context, APRICOT_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new WeightedBlockStateProvider(Pool.<BlockState>builder().add(ModBlocks.APRICOT_LEAVES.getDefaultState(), 5).add(ModBlocks.APRICOT_FRUIT_LEAVES.getDefaultState().with(Properties.PERSISTENT, false), 1)),
        ...
        register(context, PEAR_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new WeightedBlockStateProvider(Pool.<BlockState>builder().add(ModBlocks.PEAR_LEAVES.getDefaultState(), 5).add(ModBlocks.PEAR_FRUIT_LEAVES.getDefaultState().with(Properties.PERSISTENT, false), 1)),
                new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(2), ConstantIntProvider.create(3), 128),
                new TwoLayersFeatureSize(1, 0, 1)).build());
        ...
        register(context, ORANGE_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new WeightedBlockStateProvider(Pool.<BlockState>builder().add(ModBlocks.ORANGE_LEAVES.getDefaultState(), 5).add(ModBlocks.ORANGE_FRUIT_LEAVES.getDefaultState().with(Properties.PERSISTENT, false), 1)),
        ...
        register(context, KIWI_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new BendingTrunkPlacer(4, 2, 0, 3, UniformIntProvider.create(1, 2)),
                new WeightedBlockStateProvider(Pool.<BlockState>builder().add(ModBlocks.KIWI_LEAVES.getDefaultState(), 5).add(ModBlocks.KIWI_FRUIT_LEAVES.getDefaultState().with(Properties.PERSISTENT, false), 1)),
                new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 64),
                new TwoLayersFeatureSize(1, 0, 1)).build());
        ...
        register(context, PLUM_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new BendingTrunkPlacer(4, 2, 0, 3, UniformIntProvider.create(1, 2)),
                new WeightedBlockStateProvider(Pool.<BlockState>builder().add(ModBlocks.PLUM_LEAVES.getDefaultState(), 5).add(ModBlocks.PLUM_FRUIT_LEAVES.getDefaultState().with(Properties.PERSISTENT, false), 1)),
                new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 64),
                new TwoLayersFeatureSize(1, 0, 1)).build());

        register(context, PLUM_BEES_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                BlockStateProvider.of(ModBlocks.PLUM_LOG),
                new BendingTrunkPlacer(4, 2, 0, 3, UniformIntProvider.create(1, 2)),
                new WeightedBlockStateProvider(Pool.<BlockState>builder().add(ModBlocks.PLUM_LEAVES.getDefaultState(), 5).add(ModBlocks.PLUM_FRUIT_LEAVES.getDefaultState().with(Properties.PERSISTENT, false), 1)),
                new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 64),
