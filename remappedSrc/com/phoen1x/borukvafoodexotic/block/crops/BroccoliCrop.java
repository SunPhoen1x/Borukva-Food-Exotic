...
public class BroccoliCrop extends StrawberryCrop{
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        return new com.phoen1x.borukvafoodexotic.block.crops.BroccoliCrop.Model(initialBlockState);
    }
    ...
    public static class Model extends StrawberryCrop.Model {
        ...
        static{
            for (int i = 0; i <= 3; i++){
                MODELS.add(BaseItemProvider.requestModel(Identifier.of(BorukvaFoodExotic.MOD_ID, "block/broccoli_crop_stage"+i)));
            }
        }
